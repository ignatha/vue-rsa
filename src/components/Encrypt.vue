				...
				<div class="card mb-4 rounded-3 shadow-sm">
					...
					<div class="card-body">
							<div class="panel-body">
								...
								<div class="input-group mb-3 col-md-12">
									<b-button variant="outline-dark" id="plainTextTooltip" @click="showplainTextTooltip = true"  v-clipboard="plain_text_ascii">Copy!</b-button>
								...
								<div class="input-group mb-3 col-md-12">
									<b-button variant="outline-dark" id="decryptTooltip" @click="showpdecryptTooltip = true" v-clipboard="decrypt">Copy!</b-button>
									<b-tooltip target="decryptTooltip"
										:show.sync="showpdecryptTooltip"
										@shown="hideTooltipLater"
										triggers
										title="Text Copied">
									</b-tooltip>
	...
	methods: {
		...
		hideTooltipLater() {
			setTimeout(() => {
				...
				this.showpdecryptTooltip = false;
			}, 2000);
		}
	}
}
